...
public class UniversityTestListener implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		ExtentTest extentTest = ((UniversityLogin) result.getInstance()).test;
	...
	public void onTestFailure(ITestResult result) {
		...
		TakeScreenshot ww=new TakeScreenshot(); 
		ww.screenshotcapture();
